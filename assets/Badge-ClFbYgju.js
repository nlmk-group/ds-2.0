...
)`}),t.jsx(i,{description:"Варианты отображения Badge: solid и outline.",code:`import { Badge } from '@nlmk/ds-2.0';
...
)`}),t.jsx(i,{description:"Размеры Badge",code:`import { Badge } from '@nlmk/ds-2.0';
...
)`}),t.jsx(i,{description:"Кастомизация Badge через className и style.",code:`import { Badge } from '@nlmk/ds-2.0';
...
)`}),t.jsx(f,{argsTypes:b})]}),Number(r)==1&&t.jsx(x,{url:p}),Number(r)==2&&t.jsx(j,{componentName:"Badge"})]})};function a(r){return t.jsxs(t.Fragment,{children:[t.jsx(d,{title:"Components/Badge/Info",component:l,parameters:{design:{type:"figma",url:"https://www.figma.com/design/kldVs3ebNRcxsgYGttpDbU/NLMK-UI?node-id=247-12141"},jest:["Badge.test.tsx"]}}),`
`,t.jsx(n,{of:B}),`
`,t.jsx(g,{children:t.jsx(N,{})})]})}function Tr(r={}){const{wrapper:o}={...c(),...r.components};return o?t.jsx(o,{...r,children:t.jsx(a,{...r})}):a()}export{Tr as default};
