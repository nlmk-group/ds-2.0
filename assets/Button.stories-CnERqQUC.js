...
`,t($,{name:"Docs",children:t(p,{children:t(b,{})})})]})}function S(e={}){const{wrapper:r}=Object.assign({},I(),e.components);return r?t(r,{...e,children:t(d,{...e})}):d()}const g=()=>t(p,{children:t(b,{})});g.storyName="Docs";g.parameters={storySource:{source:"<Unstyled><Stories /></Unstyled>"}};const s={title:"Components/Button/Info",parameters:{design:{type:"figma",url:"https://www.figma.com/file/2bgeOS0URFNqFO1m1bnyvg/Buttons?node-id=102%3A26898&t=eLZPv4XPCGiHFviK-0"},jest:["Button.test.tsx"]},component:c,tags:["stories-mdx"],includeStories:["docs"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:S};const dt=["docs"];export{dt as __namedExportsOrder,s as default,g as docs};
