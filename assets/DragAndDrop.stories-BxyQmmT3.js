import{j as e}from"./jsx-runtime-DFnSfiB4.js";import{r as n}from"./index-DQ2WTIsS.js";import{ad as a,g as A,l as Q,m as T,ae as V,af as oe,ag as ne}from"./index-LmI_Dv35.js";import"./generateUUID-DDiDEiZj.js";import"./index-BUicYAu_.js";import"./index-CSbymPMC.js";import"./index-c1a7ry8u.js";import"./index-rzy6QoZO.js";import"./index-ehXB0alm.js";import{I as X}from"./index-BKAatnfy.js";import"./index-D_J9Vxng.js";import"./index-D5U3DYwn.js";import"./index-CLzAcar6.js";import"./32-sVrGXRAZ.js";import{a as t}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{g as o}from"./styles.module-DyNiVTaI.js";import{b as pe}from"./argsTypes-DEiAKNqb.js";import"./clsx-B-dksMZM.js";import"./index-B_snx1v7.js";import"./types-CpBSVUgC.js";import"./get-oHtgdQEu.js";import"./index-BKbm6zW0.js";import"./v4-CQkTLCs1.js";const le="DragAndDrop по умолчанию",de="DragAndDrop по размерам",ce="DragAndDrop по типам файлов",ie="DragAndDrop с кастомным набором принимаемых файлов",ee="DragAndDrop по статусам",ue="DragAndDrop Small-Icon",me="DragAndDrop с иконкой",De="DragAndDrop с самостоятельным компонентом",ge=r=>e.jsx("div",{className:o["wrapper-fit-content"],children:e.jsx(r,{})}),Me={title:"Components/DragAndDrop/Stories",component:a,decorators:[ge],argTypes:pe},D=r=>{const[s,re]=n.useState(null),[v,U]=n.useState(!1),[se,ae]=n.useState(""),[S,N]=n.useState(0),I=n.useRef(null),te=async m=>{U(!0),ae(`${m[0].name}, ${m[0].size}`),await new Promise(()=>setTimeout(()=>{U(!1),re(m[0])},2e3))};return n.useEffect(()=>(v&&S<100?I.current=setInterval(()=>{N(m=>m+1)},20):N(0),()=>{clearInterval(I.current)}),[v,S]),e.jsx(a,{loading:v,percentUpload:S,description:v?se:void 0,...r,onUpload:te})};D.storyName=le;const p=r=>e.jsx("div",{className:o["wrapper-row"],children:Object.values(A).map(s=>{if(s!==A.s)return e.jsx(a,{size:s,...r},s)})});p.storyName=de;p.args={onUpload:t("OnUpload")};const l=r=>e.jsx("div",{className:o["wrapper-row"],children:Object.values(Q).map(s=>e.jsx(a,{fileType:s,...r},s))});l.storyName=ce;l.args={onUpload:t("OnUpload")};const d=r=>e.jsx("div",{className:o["wrapper-row"],children:e.jsx(a,{...r})});d.storyName=ie;d.args={onUpload:t("OnUpload"),accept:".pdf",description:"По умолчанию только файлы формата PDF",fileType:Q.file,title:"PDF Drag&Drop"};const c=r=>e.jsx("div",{className:o["wrapper-row"],children:Object.values(T).slice(0,3).map(s=>e.jsx(a,{statusColor:s,...r},s))});c.storyName=ee;c.args={onUpload:t("OnUpload"),cancelUpload:t("onCancelUpload")};const i=r=>e.jsxs("div",{className:o["wrapper-row"],children:[Object.values(T).slice(3).map(s=>e.jsx(a,{statusColor:s,...r},s)),e.jsx(a,{loading:!0,percentUpload:75,title:V,btnLabel:oe,...r})]});i.storyName=ee;i.args={onUpload:t("OnUpload"),cancelUpload:t("onCancelUpload")};const u=r=>e.jsxs("div",{className:o["wrapper-row"],children:[Object.values(T).map(s=>e.jsx(a,{statusColor:s,...r},s)),e.jsx(a,{title:V,loading:!0,percentUpload:99,...r})]});u.storyName=ue;u.args={onUpload:t("OnUpload"),smallIcon:!0};const g=r=>e.jsx(a,{customIcon:e.jsx(X,{name:"IconUploadOutlined24"}),...r});g.storyName=me;const y=r=>e.jsx(a,{...r,children:e.jsxs("div",{className:ne["custom-component-style"],children:[e.jsx(X,{name:"IconUploadOutlined24"}),e.jsx("div",{style:{color:"var(--steel-90)"},children:"Just throw something here!"})]})});y.storyName=De;var f,j,x;D.parameters={...D.parameters,docs:{...(f=D.parameters)==null?void 0:f.docs,source:{originalSource:`(argTypes: IDragAndDropProps): ReactNode => {
...
}`,...(O=(C=p.parameters)==null?void 0:C.docs)==null?void 0:O.source}}};var E,b,h;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`(argTypes: IDragAndDropProps): ReactNode => {
  return <div className={styles['wrapper-row']}>
      {Object.values(EDnDFileType).map((fileType: EDnDFileType) => <DragAndDrop key={fileType} fileType={fileType} {...argTypes} />)}
    </div>;
}`,...(h=(b=l.parameters)==null?void 0:b.docs)==null?void 0:h.source}}};var F,P,_;d.parameters={...d.parameters,docs:{...(F=d.parameters)==null?void 0:F.docs,source:{originalSource:`(argTypes: IDragAndDropProps): ReactNode => {
  return <div className={styles['wrapper-row']}>
...
}`,...(K=(H=y.parameters)==null?void 0:H.docs)==null?void 0:K.source}}};const ke=["dndDefault","dndSizes","dndFileTypes","dndCustomAccept","dndStatuses","dndStatuses2","dndSmallIcon","dndCustomIcon","dndCustom"];export{ke as __namedExportsOrder,Me as default,y as dndCustom,d as dndCustomAccept,g as dndCustomIcon,D as dndDefault,l as dndFileTypes,p as dndSizes,u as dndSmallIcon,c as dndStatuses,i as dndStatuses2};
