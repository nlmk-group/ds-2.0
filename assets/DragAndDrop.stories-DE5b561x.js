...
}`,...(J=($=i.parameters)==null?void 0:$.docs)==null?void 0:J.source}}};var W,X,q;m.parameters={...m.parameters,docs:{...(W=m.parameters)==null?void 0:W.docs,source:{originalSource:`(argTypes: IDragAndDrop): ReactNode => {
  return <div className={styles['wrapper-row']}>
      {Object.values(statusColorMapping).map((status: statusColorMapping) => <DragAndDrop key={status} statusColor={status} {...argTypes} />)}
      <DragAndDrop title={smallTextUploadText} loading percentUpload={99} {...argTypes} />
    </div>;
}`,...(q=(X=m.parameters)==null?void 0:X.docs)==null?void 0:q.source}}};var V,Y,Z;D.parameters={...D.parameters,docs:{...(V=D.parameters)==null?void 0:V.docs,source:{originalSource:`(argTypes: IDragAndDrop): ReactNode => {
  return <DragAndDrop customIcon={<Icon name="IconUploadOutlined24" />} {...argTypes} />;
}`,...(Z=(Y=D.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var B,G,H;y.parameters={...y.parameters,docs:{...(B=y.parameters)==null?void 0:B.docs,source:{originalSource:`(argTypes: IDragAndDrop): ReactNode => {
...
}`,...(H=(G=y.parameters)==null?void 0:G.docs)==null?void 0:H.source}}};const We=["dndDefault","dndSizes","dndFileTypes","dndCustomAccept","dndStatuses","dndSmallText","dndSmallIcon","dndCustomIcon","dndCustom"];export{We as __namedExportsOrder,Je as default,y as dndCustom,d as dndCustomAccept,D as dndCustomIcon,g as dndDefault,l as dndFileTypes,p as dndSizes,m as dndSmallIcon,i as dndSmallText,c as dndStatuses};
