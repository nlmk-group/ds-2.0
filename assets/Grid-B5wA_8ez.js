...
export default App;
`,H=()=>{const[o,p]=u.useState(0);return r.jsxs("div",{className:s.wrapper,children:[r.jsx(k,{title:"Grid",description:"Grid используется для построения адаптивной раскладки на основе строк и колонок. Компонент поддерживает управление шириной, выравниванием, переносом и брейкпоинтами.",isStable:!0,codeLink:"https://github.com/nlmk-group/ds-2.0/tree/main/src/components/Grid",figmaLink:t}),r.jsx("div",{className:s.tabs,children:r.jsxs(i,{children:[r.jsx(i.Tab,{label:"Разработчику",active:Number(o)===0,onClick:()=>p(0)}),r.jsx(i.Tab,{label:"Дизайнеру",active:Number(o)===1,onClick:()=>p(1)}),r.jsx(i.Tab,{label:"Тестирование",active:Number(o)===2,onClick:()=>p(2)})]})}),Number(o)===0&&r.jsxs(r.Fragment,{children:[r.jsx(d,{minHeight:400,description:"Базовая настройка контейнера через стандартные пропсы и проп st.",code:g}),r.jsx(d,{minHeight:400,description:"Колонки равной ширины в строках.",code:v}),r.jsx(d,{minHeight:400,description:"Настройка ширины одной колонки внутри строки.",code:C}),r.jsx(d,{minHeight:400,description:"Колонка с переменной шириной контента.",code:B}),r.jsx(d,{minHeight:400,description:"Колонки равной ширины с переносом на несколько строк.",code:f}),r.jsx(d,{minHeight:400,description:"Вертикальное выравнивание колонок через alignItems.",code:w}),r.jsx(d,{minHeight:400,description:"Горизонтальное выравнивание колонок через justifyContent.",code:h}),r.jsx(d,{minHeight:400,description:"Перенос колонок при превышении ширины строки.",code:j}),r.jsx(d,{minHeight:400,description:"Явный разрыв строки между группами колонок.",code:A}),r.jsx(d,{minHeight:400,description:"Адаптивная сетка через container и size по брейкпоинтам.",code:N}),r.jsx(G,{argsTypes:y})]}),Number(o)==1&&r.jsx(l,{url:t}),Number(o)===2&&r.jsx(R,{componentName:"Grid"})]})};function e(o){return r.jsxs(r.Fragment,{children:[r.jsx(x,{title:"Components/Grid/Info",component:c,parameters:{design:{type:"figma",url:"https://www.figma.com/design/UrNaiI72SjVg0aHW6NYVCi/NLMK-Grid?node-id=207-40301"},jest:["Grid.test.tsx"]}}),`
`,r.jsx(a,{of:b}),`
`,r.jsx(m,{children:r.jsx(H,{})})]})}function Lo(o={}){const{wrapper:p}={...n(),...o.components};return p?r.jsx(p,{...o,children:r.jsx(e,{...o})}):e()}export{Lo as default};
