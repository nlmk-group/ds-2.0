import{j as o,c as b,a as m}from"./clsx.m-CcuEzMhP.js";import{r as a}from"./index-CBqU2yxZ.js";import{C as O}from"./index-BIcjFbt9.js";import{i,I as A}from"./index-BhQGQSXE.js";import{Z as L,M as $,a6 as P}from"./index-CMWTVP_7.js";import"./index-ehJh3wQv.js";import"./index-D-9trSFj.js";import"./index-DjeAniHW.js";import"./index-fOOxcv8w.js";import{T as f}from"./index-fbTu1Hcf.js";import"./index-hvdSV1r-.js";import"./index-BQVY97ak.js";import"./index-B5tj7Glx.js";import"./index-DyFb8FNg.js";const j={name:{description:"Имя иконки",table:{defaultValue:{summary:""},type:{summary:"string"}},options:[...Object.keys({...i[16],...i[24],...i[32]})],control:{type:"select"}},color:{description:"Цвет иконки",table:{defaultValue:{summary:"primary"},type:{summary:'"action" | "disabled" | "error" | "primary" | "secondary" | "inherit" | "success" | "warning"'}},options:["action","disabled","error","primary","secondary","inherit","success","warning"],control:{type:"select"}},htmlColor:{description:"HTML цвет иконки",table:{defaultValue:{summary:void 0},type:{summary:"string"}},control:{type:"color"}},containerSize:{description:"Размер контейнера иконки",table:{defaultValue:{summary:"24"},type:{summary:'"16" | "24" | "32"'}},options:[16,24,32],control:{type:"select"}},size:{description:"Физический размер иконки",table:{defaultValue:{summary:"24"},type:{summary:"number"}},options:[16,24,32],control:{type:"select"}}},R=j,H="_wrapper_8a42c_1",V="_sized_8a42c_8",K="_table_8a42c_16",W="_noResults_8a42c_23",U="_controls_8a42c_29",M="_input_8a42c_37",J="_colorControlTitle_8a42c_42",X="_colorControl_8a42c_42",Z="_colorInput_8a42c_55",q="_card_8a42c_59",G="_cardHeader_8a42c_66",Q="_icons_8a42c_73",Y="_icon_8a42c_73",ee="_iconFill_8a42c_90",ne="_strokeIcon_8a42c_94",oe="_fillAndStrokeIcon_8a42c_98",n={wrapper:H,sized:V,table:K,noResults:W,controls:U,input:M,colorControlTitle:J,colorControl:X,colorInput:Z,card:q,cardHeader:G,icons:Q,icon:Y,iconFill:ee,strokeIcon:ne,fillAndStrokeIcon:oe},te={title:"Components/Icon/Stories",component:A,argTypes:R,parameters:{layout:"fullscreen"}},r=({name:u="IconArmatura32",color:p="primary",containerSize:y=32,...s})=>o("div",{className:b(n.wrapper,n.sized),children:o(A,{name:u,color:p,containerSize:y,...s})});r.storyName="Компонент Icon по умолчанию";r.args={name:"IconArmatura32",color:"primary",containerSize:32};r.decorators=[u=>o("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"200px"},children:o(u,{})})];const l=()=>{const u=["IconJsonOutlined24","IconLightningStroke16","IconLightningStroke24","IconLightningStroke32","IconPhoneCallContact16","IconPhoneCallContact24","IconPhoneCallContact32","IconTemperatureStroke16","IconTemperatureStroke24","IconTemperatureStroke32"],p=["IconLightningFilled16","IconLightningFilled24","IconLightningFilled32","IconBasketBuying16","IconBasketBuying24","IconBasketBuying32","IconPlay16","IconPlay24","IconPlay32","IconBalanceOutlined16","IconBalanceOutlined24","IconBalanceOutlined32","IconKovsh16","IconKovsh24","IconKovsh32"],y=["IconBorder16","IconBorder24","IconBorder32"],[s,x]=a.useState(""),[w,F]=a.useState(s),d={};a.useEffect(()=>{const e=setTimeout(()=>{F(s)},500);return()=>{clearTimeout(e)}},[s]);const z=e=>{const c=e.target.value;document.documentElement.style.setProperty("--icon-color",c)},g=e=>e.replace("Icon","");Object.keys(i).forEach(e=>{Object.keys(i[e]).forEach(c=>{const t=g(c).replace(e,"");d[t]||(d[t]={});const h=c.includes("Kovsh");d[t][e]=a.createElement(i[e][c],{color:"primary",style:{...h&&{stroke:"var(--icon-color)"}}})})});const C=Object.keys(d).filter(e=>w.toLowerCase().split(" ").every(t=>e.toLowerCase().includes(t))).map(e=>({title:e,sizes:d[e]})),I=a.useRef(null);return a.useEffect(()=>{const e=getComputedStyle(document.documentElement).getPropertyValue("--icon-color").trim()||"#167ffb";I.current&&(I.current.value=e)},[]),m("div",{className:n.wrapper,children:[m("div",{className:n.controls,children:[o(L,{label:"Поиск иконок",value:s,onChange:e=>x(e.target.value),className:n.input}),m("div",{className:n.colorControl,children:[o(f,{variant:"Body1",className:n.colorControlTitle,children:"Выберите цвет:"}),o("input",{type:"color",ref:I,defaultValue:"#167ffb",onChange:z,className:n.colorInput})]})]}),o("div",{className:n.table,children:C.length>0?C.map((e,c)=>m($,{className:n.card,children:[o("div",{className:n.cardHeader,children:o(f,{variant:"Body1",color:"primary",children:P.startCase(g(e.title))})}),o("div",{className:n.icons,children:Object.entries(e.sizes).map(([t,h])=>{const S=u.includes(`Icon${e.title}${t}`),k=p.includes(`Icon${e.title}${t}`),D=y.includes(`Icon${e.title}${t}`);return o(O,{copy:`Icon${e.title}${t}`,placement:"bottom",children:o("div",{className:b(n.icon,{[n.strokeIcon]:S,[n.fillAndStrokeIcon]:k,[n.iconFill]:!S&&!k&&!D}),children:h},t)})})})]},c)):o(f,{variant:"Heading2",className:n.noResults,children:"Ничего не найдено"})})]})};l.storyName="Все доступные иконки";var _,v,N;r.parameters={...r.parameters,docs:{...(_=r.parameters)==null?void 0:_.docs,source:{originalSource:`({
  name = 'IconArmatura32',
  color = 'primary',
  containerSize = 32,
  ...args
...
}`,...(B=(E=l.parameters)==null?void 0:E.docs)==null?void 0:B.source}}};const ce=["IconComponent","AllIcons"],Ce=Object.freeze(Object.defineProperty({__proto__:null,AllIcons:l,IconComponent:r,__namedExportsOrder:ce,default:te},Symbol.toStringTag,{value:"Module"}));export{l as A,Ce as I,R as a};
