import{j as s,r as l}from"./iframe-auckHHdj.js";import{I as o}from"./index-DJL6Ketu.js";import{a as m}from"./argsTypes-DxYPxUoS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DEqo2gt9.js";import"./clsx-B-dksMZM.js";import"./index-DVSj14ZC.js";const g="InputRange-module__wrapper___KlSAO",c={wrapper:g},i=a=>s.jsx("div",{className:c.wrapper,children:s.jsx(a,{})}),S={title:"Components/InputRange/Stories",component:o,decorators:[i],argTypes:m},e=a=>{const[t,r]=l.useState({min:20,max:80}),u=p=>{r(p)};return s.jsx(o,{...a,value:t,onChange:u})};e.storyName="InputRange по умолчанию";e.args={min:20,max:80,step:1};const n=a=>{const[t,r]=l.useState({min:0,max:80}),u=p=>{r(p)};return s.jsx(o,{...a,value:t,onChange:u,disabled:!0})};n.args={min:0,max:80,step:1};n.storyName="InputRange в состоянии disabled";e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`(argsTypes: IInputRangeProps): JSX.Element => {
