...
}`,...(x=(h=t.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var C,O,f;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`(argsTypes: IModalProps): ReactNode => {
  const [isOpen, setIsOpen] = useState(false);
...
}`,...(f=(O=r.parameters)==null?void 0:O.docs)==null?void 0:f.source}}};const ae=["ModalDefault","DraggableModal","ResizableModal"];export{t as DraggableModal,n as ModalDefault,r as ResizableModal,ae as __namedExportsOrder,re as default};
