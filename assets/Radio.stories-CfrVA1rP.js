import{j as o}from"./jsx-runtime-BRNY0I4F.js";import{r as p}from"./index-Bnop-kX6.js";import{U as s,T as h}from"./TreeList-nratkZsU.js";import"./generateUUID-CKWu6hxV.js";import"./index-GIq1hJAH.js";import"./index-DppSdhCO.js";import{B as d}from"./index-ExEzblsB.js";import"./index-CH_Nznxf.js";import{T as k}from"./index-qC5wYQgy.js";import"./index-BDwZaM9Z.js";import"./index-cR4M_wwG.js";import"./index-FnAFVao7.js";import"./index-8bMf8-rB.js";import"./index-DokmLR-l.js";import"./32-DOo0Pdng.js";import{g as f}from"./styles.module-ox-emdf8.js";import{a as y}from"./argsTypes-D45k_V9r.js";import"./clsx-B-dksMZM.js";import"./index-D0sJu8id.js";import"./types-CpBSVUgC.js";import"./tiny-invariant-CopsF_GD.js";import"./index-B5g4YLzC.js";const R=a=>o.jsx("div",{className:f.wrapper,children:o.jsx(a,{})}),z={title:"Components/Radio/Stories",component:s,decorators:[R],argTypes:y},n=({checked:a,...r})=>{const[t,e]=p.useState(a?r.value:"");p.useEffect(()=>{e(a?r.value:"")},[a,r.value]);const l=i=>{e(i.target.value)};return o.jsxs(d,{flexDirection:"column",gap:"8px",children:[o.jsx(s,{...r,checked:t===r.value,onChange:l}),o.jsx(s,{checked:t==="option 2",onChange:l,value:"option 2",label:"Москва"}),o.jsxs(k,{variant:"Body1-Bold",color:"var(--steel-90)",children:["Выбранная опция: ",t]})]})};n.storyName="Переключение Radio по умолчанию";n.args={value:"option 1",label:"Липецк",checked:!1};const c=()=>{const[a,r]=p.useState(()=>Object.values(h).reduce((e,l)=>({...e,[l]:`${l}-1`}),{})),t=e=>l=>{r(i=>({...i,[e]:l.target.value}))};return o.jsx(d,{flexDirection:"column",gap:"24px",children:Object.values(h).map(e=>o.jsxs(d,{flexDirection:"column",gap:"8px",children:[o.jsx(k,{variant:"Body1-Bold",color:"var(--steel-90)",children:e}),o.jsxs(d,{flexDirection:"column",gap:"8px",children:[o.jsx(s,{color:e,value:`${e}-1`,label:"Анализ содержания углерода",checked:a[e]===`${e}-1`,onChange:t(e)}),o.jsx(s,{color:e,value:`${e}-2`,label:"Коррозионные испытания",checked:a[e]===`${e}-2`,onChange:t(e)}),o.jsx(s,{color:e,value:`${e}-3`,label:"Тест на твердость (disabled)",checked:a[e]===`${e}-3`,onChange:t(e),disabled:!0})]})]},e))})};c.storyName="Варианты цветов Radio";c.parameters={controls:{disable:!0}};var u,m,g;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`({
