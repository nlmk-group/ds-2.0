...
}`,...(Re=(De=B.parameters)==null?void 0:De.docs)==null?void 0:Re.source}}};var Ge,Qe,He;x.parameters={...x.parameters,docs:{...(Ge=x.parameters)==null?void 0:Ge.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const [selected, setSelected] = useState<TSelected>([]);
  return <div style={{
    padding: '50px',
    width: '500px'
...
}`,...(He=(Qe=x.parameters)==null?void 0:Qe.docs)==null?void 0:He.source}}};var Ke,Ue,qe;T.parameters={...T.parameters,docs:{...(Ke=T.parameters)==null?void 0:Ke.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const [selected, setSelected] = useState<TSelected>([]);
  return <div style={{
    padding: '50px',
    width: '500px'
...
}`,...(qe=(Ue=T.parameters)==null?void 0:Ue.docs)==null?void 0:qe.source}}};var Ye,Ze,$e;b.parameters={...b.parameters,docs:{...(Ye=b.parameters)==null?void 0:Ye.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const [selected, setSelected] = useState<TSelected>([]);
