...
}`,...(Re=(De=B.parameters)==null?void 0:De.docs)==null?void 0:Re.source}}};var Ge,Qe,Ke;x.parameters={...x.parameters,docs:{...(Ge=x.parameters)==null?void 0:Ge.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const [selected, setSelected] = useState<TSelected>([]);
  return <div style={{
    padding: '50px',
    width: '500px'
...
}`,...(Ke=(Qe=x.parameters)==null?void 0:Qe.docs)==null?void 0:Ke.source}}};var Ue,qe,He;T.parameters={...T.parameters,docs:{...(Ue=T.parameters)==null?void 0:Ue.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const [selected, setSelected] = useState<TSelected>([]);
  return <div style={{
    padding: '50px',
    width: '500px'
...
}`,...(He=(qe=T.parameters)==null?void 0:qe.docs)==null?void 0:He.source}}};var Ye,Ze,$e;b.parameters={...b.parameters,docs:{...(Ye=b.parameters)==null?void 0:Ye.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const [selected, setSelected] = useState<TSelected>([]);
