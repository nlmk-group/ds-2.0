...
}`,...(D=(k=b.parameters)==null?void 0:k.docs)==null?void 0:D.source}}};var V,R,H;S.parameters={...S.parameters,docs:{...(V=S.parameters)==null?void 0:V.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const {
    options: ignoredOptions,
    ...otherArgs
  } = argTypes;
...
}`,...(H=(R=S.parameters)==null?void 0:R.docs)==null?void 0:H.source}}};var K,L,q;j.parameters={...j.parameters,docs:{...(K=j.parameters)==null?void 0:K.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const {
    options: ignoredOptions,
    ...otherArgs
  } = argTypes;
...
}`,...(q=(L=j.parameters)==null?void 0:L.docs)==null?void 0:q.source}}};var G,Q,U;w.parameters={...w.parameters,docs:{...(G=w.parameters)==null?void 0:G.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const {
    options: ignoredOptions,
    ...otherArgs
  } = argTypes;
...
}`,...(U=(Q=w.parameters)==null?void 0:Q.docs)==null?void 0:U.source}}};var Y,Z,$;I.parameters={...I.parameters,docs:{...(Y=I.parameters)==null?void 0:Y.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const {
    options: ignoredOptions,
    ...otherArgs
  } = argTypes;
...
}`,...($=(Z=I.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};var ee,te,se;O.parameters={...O.parameters,docs:{...(ee=O.parameters)==null?void 0:ee.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const {
    options: ignoredOptions,
    ...otherArgs
  } = argTypes;
...
}`,...(se=(te=O.parameters)==null?void 0:te.docs)==null?void 0:se.source}}};var oe,ce,le;A.parameters={...A.parameters,docs:{...(oe=A.parameters)==null?void 0:oe.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const {
    options: ignoredOptions,
    ...otherArgs
  } = argTypes;
...
}`,...(je=(be=J.parameters)==null?void 0:be.docs)==null?void 0:je.source}}};var we,Ie,Oe;P.parameters={...P.parameters,docs:{...(we=P.parameters)==null?void 0:we.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const {
    options: ignoredOptions,
    ...otherArgs
  } = argTypes;
...
}`,...(Oe=(Ie=P.parameters)==null?void 0:Ie.docs)==null?void 0:Oe.source}}};var Ae,Ne,Ee;X.parameters={...X.parameters,docs:{...(Ae=X.parameters)==null?void 0:Ae.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const {
    options: ignoredOptions,
    ...otherArgs
  } = argTypes;
...
}`,...(_e=(Fe=h.parameters)==null?void 0:Fe.docs)==null?void 0:_e.source}}};var Be,ke,De;u.parameters={...u.parameters,docs:{...(Be=u.parameters)==null?void 0:Be.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const [selected, setSelected] = useState<TSelected>([]);
...
}`,...(De=(ke=u.parameters)==null?void 0:ke.docs)==null?void 0:De.source}}};var Ve,Re,He;m.parameters={...m.parameters,docs:{...(Ve=m.parameters)==null?void 0:Ve.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const [selected, setSelected] = useState<TSelected>([]);
  const [selectedTwo, setSelectedTwo] = useState<TSelected>([]);
  const [selectedThree, setSelectedThree] = useState<TSelected>([]);
...
}`,...(He=(Re=m.parameters)==null?void 0:Re.docs)==null?void 0:He.source}}};var Ke,Le,qe;y.parameters={...y.parameters,docs:{...(Ke=y.parameters)==null?void 0:Ke.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
  const [selected, setSelected] = useState<TSelected>([]);
  const [selectedTwo, setSelectedTwo] = useState<TSelected>([]);
  const [selectedThree, setSelectedThree] = useState<TSelected>([]);
  return <div className={styles['item-column-wrapper']}>
...
}`,...(qe=(Le=y.parameters)==null?void 0:Le.docs)==null?void 0:qe.source}}};var Ge,Qe,Ue;x.parameters={...x.parameters,docs:{...(Ge=x.parameters)==null?void 0:Ge.docs,source:{originalSource:`(argTypes: ISelectProps): JSX.Element => {
