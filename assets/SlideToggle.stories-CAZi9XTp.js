import{j as e}from"./jsx-runtime-BRNY0I4F.js";import{r as l}from"./index-Bnop-kX6.js";import{aN as n,_ as f,B as p,ah as w,e as O,az as q}from"./TreeList-KafSWxD5.js";import"./generateUUID-X09o9Pdp.js";import"./index-qbkiYuzD.js";import"./index-DppSdhCO.js";import"./index-ExEzblsB.js";import"./index-CH_Nznxf.js";import{T as c}from"./index-qC5wYQgy.js";import"./index-DovCGOp-.js";import"./index-cR4M_wwG.js";import"./index-FnAFVao7.js";import"./index-n_FSf3Cv.js";import"./index-DokmLR-l.js";import{D as A,d as J,E as W,c as X,a as y}from"./32-BTlKmMLd.js";import{g as R}from"./styles.module-ox-emdf8.js";import{a as G}from"./argsTypes-hKEp4F6F.js";import"./clsx-B-dksMZM.js";import"./index-D0sJu8id.js";import"./types-CpBSVUgC.js";import"./tiny-invariant-CopsF_GD.js";import"./index-B5g4YLzC.js";const H="_wrapper_lebkt_1",K="_color_lebkt_11",Q={wrapper:H,color:K},U=t=>e.jsx("div",{className:R.wrapper,children:e.jsx(t,{})}),fe={title:"Components/SlideToggle/Stories",component:n,decorators:[U],argTypes:G},m="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed maximus tellus non arcu dignissim, sed venenatis tortor sollicitudin. Phasellus sodales urna ut mi porttitor blandit. Integer id ligula quis ante ultrices rhoncus. Aenean mi augue, venenatis id volutpat a, vehicula vitae massa. Nullam aliquam diam eu dui imperdiet rutrum. Nam porta quam eu dolor malesuada consequat. Cras non lacinia orci, scelerisque tincidunt mi. Praesent velit turpis, euismod a dictum et, viverra et diam. Morbi feugiat erat a bibendum commodo. Nullam facilisis pulvinar justo, et posuere leo dapibus et. Morbi quam mi, rutrum sed egestas eu, rutrum vitae ipsum. Integer dignissim ex in mauris suscipit volutpat. Donec nec ipsum rutrum lectus venenatis pulvinar. Sed molestie id ex a tristique. Sed arcu augue, rhoncus at commodo ut, rutrum in libero",d=t=>{const[o,i]=l.useState(!1);return e.jsx(n,{...t,isShow:o,onToggle:()=>i(!o),children:e.jsx(c,{variant:"Body2-Medium",color:"primary",children:m})})};d.storyName="SlideToggle по умолчанию";d.args={title:"Заголовок"};const g=t=>{const[o,i]=l.useState(!1),[a,h]=l.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(n,{...t,title:t.title,isShow:o,onToggle:()=>i(!o),size:f.default,children:e.jsx(c,{variant:"Body2-Medium",color:"primary",children:m})}),e.jsx(n,{...t,title:t.title,isShow:a,onToggle:()=>h(!a),size:f.compact,children:e.jsx(c,{variant:"Body2-Medium",color:"primary",children:m})})]})};g.storyName="SlideToggle с разными размерами";g.args={title:"Заголовок"};const r=t=>{const[o,i]=l.useState(!1),[a,h]=l.useState(!1),[S,x]=l.useState(!1),[C,N]=l.useState(!1),T=s=>{console.log("click",s)},_=e.jsxs("div",{style:{display:"flex",alignItems:"center",marginLeft:"4px",gap:"4px"},children:[e.jsx(p,{type:"button",onClick:s=>{s.stopPropagation(),T(s),x(!S)},size:"s",style:{padding:"4px"},startIcon:S?e.jsx(A,{}):e.jsx(J,{}),color:"ghost",variant:"secondary"}),e.jsx(w,{size:"s",color:t.badgeColor,children:t.badgeChildren})]}),L=e.jsxs("div",{style:{display:"flex",alignItems:"center",marginLeft:"4px",gap:"4px"},children:[e.jsx(p,{type:"button",onClick:s=>{s.stopPropagation(),T(s),N(!C)},color:"ghost",variant:"secondary",size:"m",style:{padding:"4px"},startIcon:C?e.jsx(W,{}):e.jsx(X,{})}),e.jsx(w,{size:"l",color:t.badgeColor,children:t.badgeChildren})]});return e.jsxs(e.Fragment,{children:[e.jsx(n,{...t,title:t.title,isShow:o,onToggle:()=>i(!o),size:f.default,after:L,children:e.jsx(c,{variant:"Body2-Medium",color:"primary",children:m})}),e.jsx(n,{...t,title:t.title,isShow:a,onToggle:()=>h(!a),size:f.compact,after:_,children:e.jsx(c,{variant:"Body2-Medium",color:"primary",children:m})})]})};r.storyName="SlideToggle с иконкой-кнопкой";r.args={title:"Заголовок",badgeChildren:"1",badgeColor:O.error};r.argTypes={badgeColor:{description:"Заливка Badge",options:Object.values(O),control:{type:"select"}},badgeChildren:{description:"Содержимое Badge",control:{type:"text"}}};const u=t=>{const[o,i]=l.useState(!1),a=x=>{x.stopPropagation(),console.log("click")},h=e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"16px",marginLeft:"16px"},children:[e.jsx(p,{type:"button",onClick:a,iconButton:e.jsx(y,{})}),e.jsx(c,{variant:"Body2-Medium",children:t.title})]}),S=e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"16px",marginLeft:"16px"},children:[e.jsx(q,{label:"input в action block"}),e.jsx(p,{type:"button",onClick:a,iconButton:e.jsx(y,{})}),e.jsx(p,{type:"button",onClick:a,iconButton:e.jsx(y,{})}),e.jsx(p,{type:"button",onClick:a,iconButton:e.jsx(y,{})})]});return e.jsx(n,{...t,isShow:o,onToggle:()=>i(!o),title:h,after:S,children:e.jsx(c,{variant:"Body2-Medium",color:"primary",children:m})})};u.storyName="SlideToggle кастомный";u.args={className:Q.color,title:"Это кастомный title компонента SlideToggle"};var B,v,I;d.parameters={...d.parameters,docs:{...(B=d.parameters)==null?void 0:B.docs,source:{originalSource:`(args: ISlideToggleProps): JSX.Element => {
...
}`,...(P=(E=u.parameters)==null?void 0:E.docs)==null?void 0:P.source}}};const xe=["SlideToggleDefault","SlideToggleSizes","SlideToggleWithButton","SlideToggleCustomized"];export{u as SlideToggleCustomized,d as SlideToggleDefault,g as SlideToggleSizes,r as SlideToggleWithButton,xe as __namedExportsOrder,fe as default};
