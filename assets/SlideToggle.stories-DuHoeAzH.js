...
}`,...(I=(v=d.parameters)==null?void 0:v.docs)==null?void 0:I.source}}};var b,j,k;g.parameters={...g.parameters,docs:{...(b=g.parameters)==null?void 0:b.docs,source:{originalSource:`(args: ISlideToggleBaseProps): JSX.Element => {
...
}`,...(M=(z=r.parameters)==null?void 0:z.docs)==null?void 0:M.source}}};var F,E,P;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`(args: ISlideToggleBaseProps): JSX.Element => {
  const [show, setShow] = useState<boolean>(false);
  const handleClick = (e: React.MouseEvent) => {
    e.stopPropagation();
    console.log('click');
