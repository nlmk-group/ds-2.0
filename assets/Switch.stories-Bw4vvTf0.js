...
}`,...(g=(p=h.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var m,S,I;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`(argTypes: ISwitch): ReactNode => {
  const [isChecked, setIsChecked] = useState<boolean>(argTypes.checked || false);
  useEffect(() => {
    if (argTypes.checked !== isChecked) {
      setIsChecked(argTypes.checked || false);
...
}`,...(D=(E=d.parameters)==null?void 0:E.docs)==null?void 0:D.source}}};const ie=["DefaultSwitch","DisabledSwitch","SwitchWithLabel","IconsSwitch"];export{h as DefaultSwitch,r as DisabledSwitch,d as IconsSwitch,i as SwitchWithLabel,ie as __namedExportsOrder,re as default};
