...
}`,...(L=(B=T.parameters)==null?void 0:B.docs)==null?void 0:L.source}}};var R,Y,Z;C.parameters={...C.parameters,docs:{...(R=C.parameters)==null?void 0:R.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
  const [value, setValue] = useState(new Date());
  const handleValueChange = (newValue: Date) => {
    setValue(newValue);
    if (argTypes.onChange) {
...
}`,...(Z=(Y=C.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var q,z,A;v.parameters={...v.parameters,docs:{...(q=v.parameters)==null?void 0:q.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
...
}`,...(A=(z=v.parameters)==null?void 0:z.docs)==null?void 0:A.source}}};var G,K,Q;V.parameters={...V.parameters,docs:{...(G=V.parameters)==null?void 0:G.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
  const [value, setValue] = useState(new Date());
  const handleValueChange = (newValue: Date) => {
    setValue(newValue);
    if (argTypes.onChange) {
...
}`,...(Q=(K=V.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};var U,$,ee;P.parameters={...P.parameters,docs:{...(U=P.parameters)==null?void 0:U.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
