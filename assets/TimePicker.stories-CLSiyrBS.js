...
}`,...(R=(L=T.parameters)==null?void 0:L.docs)==null?void 0:R.source}}};var Z,$,q;C.parameters={...C.parameters,docs:{...(Z=C.parameters)==null?void 0:Z.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
  const [value, setValue] = useState(new Date());
  const handleValueChange = (newValue: Date) => {
    setValue(newValue);
    if (argTypes.onChange) {
...
}`,...(U=(Q=V.parameters)==null?void 0:Q.docs)==null?void 0:U.source}}};var Y,ee,ae;P.parameters={...P.parameters,docs:{...(Y=P.parameters)==null?void 0:Y.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
