...
}`,...(H=(I=g.parameters)==null?void 0:I.docs)==null?void 0:H.source}}};var _,B,R;T.parameters={...T.parameters,docs:{...(_=T.parameters)==null?void 0:_.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
  const [value, setValue] = useState(new Date());
  const handleValueChange = (newValue: Date) => {
    setValue(newValue);
    if (argTypes.onChange) {
...
}`,...(R=(B=T.parameters)==null?void 0:B.docs)==null?void 0:R.source}}};var L,Q,q;C.parameters={...C.parameters,docs:{...(L=C.parameters)==null?void 0:L.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
  const [value, setValue] = useState(new Date());
  const handleValueChange = (newValue: Date) => {
    setValue(newValue);
    if (argTypes.onChange) {
...
}`,...(q=(Q=C.parameters)==null?void 0:Q.docs)==null?void 0:q.source}}};var z,A,G;v.parameters={...v.parameters,docs:{...(z=v.parameters)==null?void 0:z.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
