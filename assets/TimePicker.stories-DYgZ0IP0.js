...
}`,...(O=(j=p.parameters)==null?void 0:j.docs)==null?void 0:O.source}}};var N,J,M;d.parameters={...d.parameters,docs:{...(N=d.parameters)==null?void 0:N.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
  const [value, setValue] = useState(new Date());
  const func = (): any => {
    return 32;
  };
...
}`,...(M=(J=d.parameters)==null?void 0:J.docs)==null?void 0:M.source}}};var X,I,H;g.parameters={...g.parameters,docs:{...(X=g.parameters)==null?void 0:X.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
  const [value, setValue] = useState(new Date());
  const func = (): any => {
    return 2;
  };
...
}`,...(L=(B=T.parameters)==null?void 0:B.docs)==null?void 0:L.source}}};var R,U,q;C.parameters={...C.parameters,docs:{...(R=C.parameters)==null?void 0:R.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
  const [value, setValue] = useState(new Date());
  const handleValueChange = (newValue: Date) => {
    setValue(newValue);
    if (argTypes.onChange) {
...
}`,...(q=(U=C.parameters)==null?void 0:U.docs)==null?void 0:q.source}}};var z,A,G;v.parameters={...v.parameters,docs:{...(z=v.parameters)==null?void 0:z.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
...
}`,...(G=(A=v.parameters)==null?void 0:A.docs)==null?void 0:G.source}}};var K,Q,Y;V.parameters={...V.parameters,docs:{...(K=V.parameters)==null?void 0:K.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
  const [value, setValue] = useState(new Date());
  const handleValueChange = (newValue: Date) => {
    setValue(newValue);
    if (argTypes.onChange) {
...
}`,...(Y=(Q=V.parameters)==null?void 0:Q.docs)==null?void 0:Y.source}}};var Z,$,ee;P.parameters={...P.parameters,docs:{...(Z=P.parameters)==null?void 0:Z.docs,source:{originalSource:`(argTypes: TTimePickerType): JSX.Element => {
