...
}`,...(B=(E=i.parameters)==null?void 0:E.docs)==null?void 0:B.source}}};var D,F,g;n.parameters={...n.parameters,docs:{...(D=n.parameters)==null?void 0:D.docs,source:{originalSource:`(argsTypes: Args): JSX.Element => {
  return <div className={styles.wrapper}>
      <Tooltip description="Сюда вы можете добавить текст/подсказу для компонента" {...argsTypes}>
        <span>
...
}`,...(g=(F=n.parameters)==null?void 0:F.docs)==null?void 0:g.source}}};var C,N,A;a.parameters={...a.parameters,docs:{...(C=a.parameters)==null?void 0:C.docs,source:{originalSource:`(argsTypes: Args): JSX.Element => {
...
}`,...(A=(N=a.parameters)==null?void 0:N.docs)==null?void 0:A.source}}};var _,f,b;p.parameters={...p.parameters,docs:{...(_=p.parameters)==null?void 0:_.docs,source:{originalSource:`(argsTypes: Args): JSX.Element => {
  return <div className={styles.wrapper}>
...
}`,...(b=(f=p.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var w,S,k;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`(argsTypes: Args): JSX.Element => {
  return <div className={styles.wrapper}>
