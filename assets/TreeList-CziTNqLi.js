...
};`}),e.jsx(g,{argsTypes:k})]}),Number(t)===1&&e.jsx(f,{url:i}),Number(t)===2&&e.jsx(x,{componentName:"TreeList"})]})};function s(t){return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:"Components/TreeList/Info",component:d,parameters:{design:{type:"figma",url:"https://www.figma.com/design/kldVs3ebNRcxsgYGttpDbU/NLMK-UI?node-id=417-86981&p=f&t=pOZSSeIHfpaoa1eT-0"},jest:["TreeList.test.tsx"]}}),`
`,e.jsx(l,{of:c}),`
`,e.jsx(p,{children:e.jsx(T,{})})]})}function te(t={}){const{wrapper:o}={...n(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(s,{...t})}):s()}export{te as default};
