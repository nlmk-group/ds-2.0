...
|--------|----------------|---------|------------------------------------------------------|
| locale | 'ru' \| 'en'   | 'ru'    | Локаль для форматирования дня недели (Среда/Wednesday) |
...
- Формат даты всегда `ДД.ММ.ГГГГ` (российский стандарт), независимо от локали.
- День недели выводится с заглавной буквы и зависит от выбранной локали:
  - `locale="ru"` → "Среда"
  - `locale="en"` → "Wednesday"
