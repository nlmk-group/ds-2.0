...
|--------|----------------|---------|------------------------------------------------------|
| locale | 'ru' \| 'en'   | 'ru'    | Язык дня недели. Определяет язык, на котором отображается название дня недели (Среда/Wednesday). Формат даты (ДД.ММ.ГГГГ) всегда остается российским. |
