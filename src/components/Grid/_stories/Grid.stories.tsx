  ...
  return (
    <Grid borderRadius="4px" {...argTypes}>
      {Array.from({ length: 3 }, (_, index) => (
        <Box key={index} px="8px" py="16px" borderRadius="4px" background="var(--spectrum-sky-40)" st={{ flex: '1' }}>
          Контент {index + 1}
        </Box>
      ))}
    </Grid>
  ...
  return (
    <Grid {...argTypes}>
      <Column st={{ flex: '1' }} background="var(--spectrum-red-30)">
        <Box st={{ flex: '1' }} px="8px" py="16px" borderRadius="4px" background="var(--spectrum-sky-40)">
          Контент 1
        </Box>
        <Box st={{ flex: '1' }} px="8px" py="16px" borderRadius="4px" background="var(--spectrum-sky-40)">
          Контент 2
...
export const GridBootstrapResponsive = (argTypes: IBox): JSX.Element => {
  return (
    <Grid container gap={16} borderRadius="4px" {...argTypes}>
      <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
        <Box px="8px" py="16px" borderRadius="4px" background="var(--spectrum-sky-40)" st={{ textAlign: 'center' }}>
