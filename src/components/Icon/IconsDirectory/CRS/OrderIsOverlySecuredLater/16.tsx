...
const IconOrderIsOverlySecuredLater16: FC<IIconsProps> = ({ color = 'inherit', htmlColor }) => {
  const classes = clsx(styles[color as keyof typeof styles]);

  return (
    <svg width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg" className={classes}>
      <path fill={htmlColor || 'var(--spectrum-red-40)'} d="M1.333 5.158h13.333v7.579H1.333v-7.58Z" />
      <path fill={htmlColor || 'var(--spectrum-red-40)'} d="M2.666 2.632h9.667a1 1 0 0 1 1 1v9.736H2.666V2.632Z" />
      <path
        fill={'var(--steel-80)'}
        fillRule="evenodd"
        d="M2.666 7.684v5.053h10.667V7.684h1.333v5.053c0 .697-.597 1.263-1.333 1.263H2.666c-.736 0-1.333-.566-1.333-1.263V7.684h1.333Z"
        clipRule="evenodd"
      />
      <path
        fill={'var(--steel-10)'}
...
export default IconOrderIsOverlySecuredLater16;
