...
const IconOrderIsSecured16: FC<IIconsProps> = ({ color = 'inherit', htmlColor }) => {
  ...
  return (
    <svg width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg" className={classes}>
      <path fill={htmlColor || '#43AE5A'} d="M1.983 6.571h11.7v5.786h-11.7V6.571Z" />
      <path
        fill={'#3C4A56'}
        fillRule="evenodd"
        ...
        clipRule="evenodd"
      />
      <path fill={'#3C4A56'} fillRule="evenodd" d="M13.033 6.571h-10.4V5.286h10.4V6.57Z" clipRule="evenodd" />
    </svg>
  );
};
