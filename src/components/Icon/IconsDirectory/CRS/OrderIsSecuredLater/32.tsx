...
const IconOrderIsSecuredAfter32: FC<IIconsProps> = ({ color = 'inherit', htmlColor }) => {
  ...
  return (
    <svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg" className={classes}>
      <path fill={htmlColor || 'var(--spectrum-green-50)'} d="M4 16h24v12H4V16Z" />
      <path
        fill={'var(--steel-80)'}
        fillRule="evenodd"
        ...
        clipRule="evenodd"
      />
      <path fill={'var(--steel-80)'} fillRule="evenodd" d="M26.667 16H5.334v-2.667h21.333V16Z" clipRule="evenodd" />
