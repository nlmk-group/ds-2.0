...
export const IconArrowBottom16: FC<IIconsProps> = ({ color = 'inherit', htmlColor }) => {
  ...
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={classes}>
      ...
      />
      <path d="M1.33334 12.6667H14.6667V14.0001H1.33334V12.6667Z" fill={htmlColor || 'currentColor'} />
    </svg>
  );
};
