...
export const IconReservedFrom24: FC<IIconsProps> = ({ color = 'inherit', htmlColor }) => {
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={classes}>
      ...
      <path
        d="M5.8284 5.70711L8.12129 3.41421L6.70708 2L1.99997 6.70711L6.70708 11.4142L8.12129 10L5.8284 7.70711H12.4142V5.70711H5.8284Z"
