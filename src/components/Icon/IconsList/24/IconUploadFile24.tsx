...
const IconUploadFile24: FC<IIconsProps> = ({ color = 'inherit', htmlColor }) => {
  const classes = clsx(styles[color as keyof typeof styles]);
  return (
    <svg width="24" height="24" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg" className={classes}>
      <path
...
export default IconUploadFile24;
