...
export const IconDeleteBinOutlined32: FC<IIconsProps> = ({ color = 'inherit', htmlColor }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none" viewBox="0 0 32 32" className={classes}>
      ...
      />
      <path fill="currentColor" d="M11.5 12.5v13H13v-13h-1.5Zm4 0v13H17v-13h-1.5Zm4 0v13H21v-13h-1.5Z" />
    </svg>
  );
};
