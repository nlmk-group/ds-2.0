...
/**
 * Перечисление вариантов отображения Legend
 * @enum {string}
 */
...
/**
 * Компонент Legend предоставляет интерактивное выпадающее меню с выбором цвета из списка
 */
declare const Legend: FC<ILegendProps>;
