...
import { Tab, Tooltip, Icon } from '@components/index';
import { render } from '@testing-library/react';

describe('src/components/Tab', () => {
  // Check render tab at DOM
  test('It should render an Tab', () => {
    const { container } = render(<Tab label="Hello World!" />);
  ...
  test('It should render an Tab with badge inside', () => {
    ...
    const { container } = render(
      <Tab label="Hello World!" badgeNumber={number} />
    );
  ...
  test('It should render an active Tab', () => {
    const { container } = render(<Tab label="Hello World!" active />);
