...
export interface ITabsProps {
  ...
  /**
   * Принудительное включение прокрутки со стрелками. По умолчанию не требуется:
   * компонент сам через ResizeObserver отслеживает переполнение и автоматически
   * показывает стрелки навигации, когда табы не помещаются в контейнер.
   */
  scrollable?: boolean;
