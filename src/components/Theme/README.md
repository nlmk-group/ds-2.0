...
> **Примечание:** Хук автоматически сохраняет выбранную тему в `sessionStorage` и восстанавливает её при следующей загрузке страницы.

> **Примечание:** Хук `useThemeSwitcher` возвращает объект `{ theme, toggleTheme }`, где:
>
