...
| stretch | boolean | - | Делает область, на которую можно навести/кликнуть для показа тултипа, растянутой на весь размер родительского контейнера |
| style | CSSProperties | - | Задает инлайн-стили для области-триггера тултипа |
