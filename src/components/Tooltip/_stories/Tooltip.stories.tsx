...
import { Badge, Button, IconCloseOutlined24, IconDoneCheckOutlined24, IconQuestionMarkOutlined24, Tooltip } from '@components/index';
    ...
    <div className={styles.wrapper}>
      <div className={styles.placements}>
        ...
        <div className={styles['tooltip-top-left']}>
          <Tooltip
            placement={ETooltipPlacementType['top-start']}
            description="Tooltip on top start"
            {...argsTypes}
          >
        ...
        <div className={styles['tooltip-top-right']}>
          <Tooltip
            placement={ETooltipPlacementType['top-end']}
            description="Tooltip on top end"
            {...argsTypes}
          >
        ...
        <div className={styles['tooltip-left-start']}>
          <Tooltip
            placement={ETooltipPlacementType['left-start']}
            description="Tooltip on left start"
            {...argsTypes}
          >
        ...
        <div className={styles['tooltip-right-start']}>
          <Tooltip
            placement={ETooltipPlacementType['right-start']}
            description="Tooltip on right start"
            {...argsTypes}
          >
        ...
        <div className={styles['tooltip-left']}>
          <Tooltip
            placement={ETooltipPlacementType['left']}
        ...
        <div className={styles['tooltip-right']}>
          <Tooltip
            placement={ETooltipPlacementType["right"]}
        ...
        <div className={styles['tooltip-left-end']}>
          <Tooltip
            placement={ETooltipPlacementType["left-end"]}
            description="Tooltip on left end"
            {...argsTypes}
          >
            <Button variant="secondary">Наведи, тултип будет слева!</Button>
          </Tooltip>
        ...
        <div className={styles['tooltip-right-end']}>
          <Tooltip
            placement={ETooltipPlacementType["right-end"]}
            description="Tooltip on right end"
            {...argsTypes}
          >
            <Button variant="secondary">Наведи, тултип будет справа!</Button>
          </Tooltip>
        ...
        <div className={styles['tooltip-bottom']}>
          <Tooltip
            placement={ETooltipPlacementType.bottom}
        ...
        <div className={styles['tooltip-bottom-right']}>
          <Tooltip
            placement={ETooltipPlacementType['bottom-end']}
            description="Tooltip on bottom end"
            {...argsTypes}
          >
