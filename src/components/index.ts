...
export * from './ArrowButton/enums';
export * from './ArrowButton/types';
...
export * from './Header/subcomponents';

export { default as Icon } from './Icon';
export { default as IconContainer } from './Icon/subcomponent/IconContainer';
export { default as IconUnit } from './Icon/IconUnit';
export * from './Icon/IconsDirectory';
export * from './Icon/IconsDirectory/unionType';
...
export * from './Stepper/subcomponents/Step/enums';
